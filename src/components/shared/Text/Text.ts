...
import { Text as UuiText, TextCoreProps, TextProps as UuiTextProps } from "@epam/uui";
...
export interface TextMods {
     ...
     */
    font?: "Inter" | "Prompt";
    color?: 'info' | 'warning' | 'critical' | 'success' | 'primary' | 'secondary' | 'tertiary' | 'disabled' | 'white';
}
